...
from personaparlour.prompts import DEFAULT_IMAGE_DESCRIPTION_PROMPT
from personaparlour.utils import logger, resolve_local_model_path
...
class ImageExplainer(ImageExplainerEngine):
    ...
    def load_model(self):
        ...
        from personaparlour.utils import get_resource_monitor
